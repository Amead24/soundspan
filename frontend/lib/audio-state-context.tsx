        ...
        api.getPlaybackState()
            .then((serverState) => {
                ...
                if (
                    ...
                    // Mixed-media queues can hold podcast episodes whose
                    // composite ids never describe a current *track*; only
                    // track-shaped queue items may be materialized here.
            ...
            try {
                ...
                if (
                    ...
                    if (
                        ...
                        // Mixed-media queues can hold podcast episodes whose
                        // composite ids never describe a current *track*;
                        // only track-shaped queue items are restorable here.
                        if (
                            remoteQueueTrack &&
